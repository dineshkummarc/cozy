...
if (TestRunner.results === undefined) {
  fail();
} else {
  pass();
}
...
if (TestRunner.passedCount === undefined) {
  fail();
} else {
  pass();
}
...
if (TestRunner.failedCount === undefined) {
  fail();
} else {
  pass();
}
...
if (TestRunner.errorCount === undefined) {
  fail();
} else {
  pass();
}
...
if (TestRunner.testDefaults === undefined) {
  fail();
} else {
  pass();
}
