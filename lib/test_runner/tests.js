...
announce('2.1.1. If any of the items of the array passed to TestRunner.run is not a valid test object, an exception is thrown.');
...
announce('5.1. TestRunner.validateTest throws an exception if the argument does not have a "description" property of type string, a "method" property of type function, a "arguments" property of type array, and an "expected" property of any type.');
...
announce('5.3. When executing the registerPassed method the passedCount is incremented by 1.');
...
announce('7.3. The TestRunner.registerFailed method execution increments failedCount property by 1.');
